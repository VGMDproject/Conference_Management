...
public class User implements java.io.Serializable{
	...
	private static final long serialVersionUID = -7541431533026824552L;
...
//			+"\nUser Name : "+myData.getUser()+ "\nUser Roles are : " +myData.getRole().get(0));
	 ...
	 * @return
	 */
	public String register(String theUserName){
		//
		int counter = 0;
...
//		}
		if(myUserNameList.contains(theUserName)){
			...
			Data.dataList.add(myData);
			counter = 0;
//			System.out.println("After the Add new ");
//			for(int i = 0 ; i < Data.dataList.size(); i++){
//				//System.out.println(Data.dataList.get(i).getConf());
//				if(Data.dataList.get(i).getConf().equals(myConference)){
//					System.out.println((counter+1)+") "+Data.dataList.get(i).getUser());
//					counter++;
//				}
//			}
			//Data.dataList.set(index, element)
			//System.out.println("index num :" + myConfNum);
			//myRoleMap.put(theUserName, myRoleMap);
			//myRoleMap.put(key, value)
	 ...
	 * 
	 */
	public static void makeSerialize(User theUser){
		try {
